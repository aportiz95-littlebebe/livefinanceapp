...
def render_combined_envelopes_modal():
    ...
    def save_buck(idx):
        ...
        if new_name != old_name and new_name.strip():
            ...
            st.session_state.temp_bucket_config[new_name] = {"initial": new_init, "pct": new_pct, "overflow": new_over}
            ...
            st.session_state.temp_bucket_config[old_name] = {"initial": new_init, "pct": new_pct, "overflow": new_over}
    ...
    def add_bucket():
        ...
        o = st.session_state.get("new_b_over", False)
        if n and n not in st.session_state.temp_bucket_config:
            st.session_state.temp_bucket_config[n] = {"initial": i, "pct": p, "overflow": o}
            ...
            st.session_state["new_b_over"] = False
